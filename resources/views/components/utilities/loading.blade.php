<div role="status" class="space-y-7 animate-pulse max-h-screen" id="loading-placeholder">
    <div role="status" class="animate-pulse">
        <div class="flex items-center space-x-4">
            <div class="w-full">
                <div class="h-2.5 bg-gray-300 rounded-full dark:bg-gray-700  mb-2.5 mx-auto w-full"></div>
                <div class="h-2.5 mx-auto bg-gray-300 rounded-full dark:bg-gray-700 w-full"></div>
            </div>
